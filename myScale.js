...
function presentDay() {
  ...
  const linhaOntem = tableLines[day].querySelectorAll('td');  
      ...
      if (hour < 8) {
          ...
          linhaOntem[5].style.backgroundColor = '#bf9cff';
          linhaOntem[5].style.color = 'white';
        } else if (hour >= 8 && hour < 12) {
          linhaHoje[2].style.backgroundColor = '#bf9cff';
          ...
          linhaHoje[2].style.backgroundColor = '#bf9cff';
          linhaHoje[2].style.color = 'white';
          linhaHoje[3].style.backgroundColor = '#bf9cff';
          ...
          linhaHoje[3].style.backgroundColor = '#bf9cff';
          linhaHoje[3].style.color = 'white';
          linhaHoje[4].style.backgroundColor = '#bf9cff';
          ...
          linhaHoje[3].style.backgroundColor = '#5e5e5e';
          linhaHoje[4].style.backgroundColor = '#5e5e5e';
          linhaHoje[5].style.backgroundColor = '#bf9cff';
